...
PASS_STATUSES = {"GPS_READY_FULL", "GPS_FIX_NO_LOCAL_POSE", "GPS_WAITING"}


def load_summary(path: Path) -> dict[str, object]:
    if path.is_dir():
        path = path / "gps_long_outdoor_watch_summary.json"
...
def main(argv: Sequence[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Check GPS long outdoor watch output.")
